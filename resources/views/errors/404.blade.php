...
<!-- /font files -->
<!-- css files -->
<link href="/resources/assets/templates/errors/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- /css files -->
<!-- js files -->
...
<div class="container demo-2">
	<div class="content">
        <div id="large-header" class="large-header">
			...
			<img src="/resources/assets/templates/errors/images/owl.gif" alt="flashy" class="w3l">
            <h2 class="main-title">404</span></h2>
			<p class="w3-agileits2">We can't seem to find the page you're looking for.</p>
			<p class="copyright">© 2017 Flashy Error Page. All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">Dai Duong Nguyen Huu</a></p>
        </div>
	</div>
</div>	
<!-- js files -->
<script src="/resources/assets/templates/errors/js/rAF.js"></script>
<script src="/resources/assets/templates/errors/js/demo-2.js"></script>
<!-- /js files -->
</body>
</html>